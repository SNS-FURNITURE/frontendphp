...
class InventoryService
{
    ...
    {
        DB::transaction(fn () => $this->applyMovementUnsafe($payload, $user));
    }

    /**
     * Same as applyMovement but assumes the caller already owns a DB transaction.
     *
     * @param  array{item_id:mixed,movement_type:string,quantity:mixed,warehouse?:string,reference_type?:mixed,reference_id?:mixed}  $payload
     */
    public function applyMovementUnsafe(array $payload, ?User $user = null): void
    {
