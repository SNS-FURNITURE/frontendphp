...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .brand span { font-family: Fraunces, Georgia, serif; font-size: 1.15rem; }
        .nav-links { display: flex; gap: 1.1rem; align-items: center; flex-wrap: wrap; }
        .nav-links a { color: var(--ink); font-weight: 500; font-size: 0.95rem; text-decoration: none; }
        ...
        .btn-primary:hover { background: var(--wood); text-decoration: none; color: #fff; }
        .btn-ghost { background: transparent; color: var(--ink); border: 1px solid var(--line); }
        .btn-ghost:hover { border-color: var(--wood); color: var(--wood); text-decoration: none; }
        .btn-accent { background: var(--accent); color: #fff; }
        .btn-accent:hover { filter: brightness(1.05); text-decoration: none; color: #fff; }
        .hero {
        ...
        .section-head h2 { font-family: Fraunces, Georgia, serif; font-size: clamp(1.7rem, 3vw, 2.3rem); margin: 0; }
        ...
        .product-card h3 { margin: 0; font-size: 1.05rem; font-family: Fraunces, Georgia, serif; }
        .price { font-weight: 700; color: var(--wood-deep); }
        .filters {
        ...
        .panel h3 { margin-top: 0; font-family: Fraunces, Georgia, serif; }
        .map { width: 100%; height: 240px; border: 0; border-radius: 14px; }
        .hours { list-style: none; padding: 0; margin: 0; }
        .hours li { display: flex; justify-content: space-between; gap: 1rem; padding: 0.45rem 0; border-bottom: 1px solid var(--line); }
        .flash { background: #e8f5e9; color: #1b5e20; padding: 0.75rem 1rem; border-radius: 12px; margin-bottom: 1rem; }
        .errors { background: #fdecea; color: #8b1a12; padding: 0.75rem 1rem; border-radius: 12px; margin-bottom: 1rem; }
        form label { display: block; font-size: 0.8rem; font-weight: 600; margin: 0.65rem 0 0.25rem; }
        ...
        .site-footer {
            border-top: 1px solid var(--line); padding: 2.5rem 0 2rem; margin-top: 2rem; background: #efe8dc;
        }
        .footer-grid { display: grid; grid-template-columns: 1.4fr 1fr 1fr; gap: 1.5rem; }
        .footer-grid h4 { margin: 0 0 0.6rem; font-family: Fraunces, Georgia, serif; }
        .footer-grid ul { list-style: none; padding: 0; margin: 0; }
        .footer-grid li { margin: 0.35rem 0; }
        .footer-grid a { color: var(--ink); }
        .rating { display: inline-flex; align-items: center; gap: 0.35rem; font-weight: 600; }
